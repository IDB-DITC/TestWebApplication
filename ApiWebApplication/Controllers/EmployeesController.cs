...
namespace ApiWebApplication.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        {
            return Ok(await _context.Employees.Include(e=> e.Experiences).Include(a=> a.Designation).ToListAsync());
        }
        ...
        {
            var employee = await _context.Employees.Include(e => e.Experiences).Include(a => a.Designation).FirstOrDefaultAsync(a=> a.EmpId == id);
